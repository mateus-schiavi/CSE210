...
class Program
{
    ...
    static void Main(string[] args)
    {
        try
        {
            ...
            Console.WriteLine("1. Principles");
            Console.WriteLine("2. Benefits");
            Console.WriteLine("3. Application");
            Console.WriteLine("4. Example of Encapsulation");
            ...
            else if(_decision == 4)
            {
                ...
                Console.writel("I will give an example from a code I wrote");
